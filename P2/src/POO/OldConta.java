...
public class OldConta {
	...
	public void transferirPara(OldConta contaDestino, double valor) {
	...
	public static OldConta getContaPorNome(OldConta[] contas, String nome) {
		// Modo 1: "For" convencional
		for (int i = 0; i < contas.length; i++) {
			if (
				contas[i].getNomeCliente().equalsIgnoreCase(nome)) {
				return contas[i];
			}
		}
