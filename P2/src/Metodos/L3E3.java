			...
			try {				
				...
				case 2:
					...
					if (Util.isOnArray(login, novoLogin)) {
						System.out.println("Digite sua senha");
						novaSenha = entrada.nextLine();
						if (senhas[Util.getIndexOf(login, novoLogin)].equalsIgnoreCase(novaSenha)) {
				...
				case 4:
					...
					if (Util.isOnArray(login, novoLogin)) {
						System.out.println("Digite sua senha");
						novaSenha = entrada.nextLine();
						if (senhas[Util.getIndexOf(login, novoLogin)].
								equalsIgnoreCase(novaSenha)) {
							System.out.println("Digite a nova senha");
							novaSenha = entrada.nextLine();

							senhas[Util.getIndexOf(login, novoLogin)] = novaSenha;
